...
public class MD5Util {
	...
	/**
	 *
	 * @param credentials 用户名
	 * @return
	 */
	public String shiroSalt(String credentials){
		...
		return new SimpleHash("SHA-256", credentials, salt, 3).toString();
	}
